		...
		<div class="row">
			<div class="col-md-4">
				<div class="team text-center">
					...
					<button data-toggle="modal" data-target="#modal-fh-jdw1" class="btn btn-blue-fill">Lihat Jadwal</button>
				</div>
			</div>
			<div class="col-md-4">
				<div class="team text-center">
					...
					<a href="#" data-toggle="modal" data-target="#modal-fh-jdw2" class="btn btn-blue-fill ripple">Lihat Jadwal</a>
				</div>
			</div>
			<div class="col-md-4">
				<div class="team text-center">
					...
					<a href="#" data-toggle="modal" data-target="#modal-fh-jdw3" class="btn btn-blue-fill ripple">Lihat Jadwal</a>
				</div>
			</div>
		</div>
	</div>
						...
						<div class="schedule-row row">
							<div class="col-xs-6 text-left">
								<h5 class="regular-fh white p-thin-fh"><b>Paralel Events<br>
									...
									<b>Paralel 2</b><br>
									Tema: Bisnis dan HAM (INFID)<br>
									Narasumber:<br>
									Moderator: Komisioner Komnas HAM<br><br>
									<b>Paralel 3</b><br>
									Tema: Tema: Menghapus Diskriminasi terhadap Perempuan (SGDs dan Gender) (Komnas Perempuan)<br>
									Narasumber:<br>
									Moderator: KSP<br><br>
									<b>Paralel 4</b><br>
									Tema: Anak Muda dan HAM (Kemenpora)<br>
									Narasumber: Komnas HAM + Narasumber Lain<br>
									Moderator: <br><br>
									<b>Sesi Khusus</b><br>
						...
						<div class="schedule-row row">
							<div class="col-xs-6 text-left">
								<h5 class="regular-fh white p-thin-fh"><b>Diskusi Paralel<br>
									...
									Moderator:<br><br>
									<b>Paralel 7</b><br>
									Tema: Hak atas rasa aman di dunia Pendidikan: menghapus kekerasan di sekolah dan perguruan tinggi (Kemendikbud)<br>
									Narasumber:<br>
									Moderator: KSP<br><br>
									<b>Paralel 8</b><br>
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-6 text-center-mobile">
				<img style="max-width:300px" src="assets/img/logo-fh1.png" data-active-url="assets/img/logo-fh1.png" alt="">
